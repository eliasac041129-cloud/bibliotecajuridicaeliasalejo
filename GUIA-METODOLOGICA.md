...
> Cómo convertir esta biblioteca en expertise real y duradera. Construida sobre la
...
**Recuperación activa (active recall).** Aprendemos al *recuperar* la información, no
al releerla. Por eso cada libro termina en flashcards, preguntas y casos: el objetivo
es que cierres el libro e intentes reconstruir lo aprendido.

**Repaso espaciado (spaced repetition).** Repasa en intervalos crecientes (1 día, 3
días, 1 semana, 2 semanas, 1 mes). Usa las flashcards de cada libro con un sistema
tipo Anker/Anki.
...
- **Sesiones de 50–90 minutos** con descansos (técnica de bloques + pausas).
- **Una materia central por bloque**, intercalando una secundaria.
- **Escribe a mano o tecleando** tus respuestas: la producción fija la memoria.

---

## 4. De estudiante a abogado

Cada tema debe pasar por cuatro estados mentales:

1. **Lo reconozco** (lo leí).
2. **Lo entiendo** (puedo explicarlo a otro).
3. **Lo aplico** (resuelvo un caso nuevo).
4. **Lo critico y negocio** (veo sus límites y lo uso como herramienta estratégica).

La biblioteca está diseñada para llevarte del estado 1 al 4 en cada institución.

---

## 5. Bitácora del jurista
