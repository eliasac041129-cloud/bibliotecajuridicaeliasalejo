...
> establece el **marco**: qué es la materia mercantil, quién es comerciante, qué es un acto de
> comercio y qué es la empresa. Sobre él se montarán las sociedades, los títulos de crédito y el
> mercado de valores.

**Etiquetas:** derecho mercantil · acto de comercio · comerciante · empresa · fuentes mercantiles
**Prerrequisitos:** Nivel I completo y [Nivel II · Derecho Civil Profundo](../Nivel-II-Derecho-Civil-Profundo/) (el mercantil es derecho privado **especial** que se apoya en el civil).
**Estándar:** V3 (43 secciones + secciones transversales).
**⏱ Tiempo estimado de dominio:** 2–3 semanas (≈ 25–35 h de estudio activo). Lectura de
reconocimiento: 5–6 h. *Es la puerta de entrada al Nivel III: relativamente breve pero
conceptualmente decisivo.*

> **Aviso de método.** Tratado, no repaso. Construimos el **andamiaje conceptual** del Derecho
> Mercantil con la profundidad necesaria para que el resto del Nivel III (sociedades, títulos,
> valores) se entienda como un **sistema**, no como leyes sueltas.
...
Empresa Familiar     ★★★★☆
```
*Es materia fundacional: define el "campo de juego" (mercantilidad, empresa, comerciante) sobre el
que operan todas las especialidades corporativas.*

---

## 1. Introducción

¿Por qué existe un derecho **mercantil** separado del **civil**, si ambos regulan contratos,
obligaciones y bienes? Porque el comercio tiene **exigencias propias**: necesita **rapidez** (las
operaciones se cierran en minutos, no con la solemnidad del derecho civil), **seguridad y
circulación** (el crédito y los títulos deben moverse con fluidez), **buena fe profesional** (entre
comerciantes que se presumen expertos) y **dimensión internacional** (el comercio cruza fronteras
desde siempre). El Derecho Mercantil nació para responder a esas exigencias con reglas más ágiles
que las del derecho común.

La idea central de este libro: el Derecho Mercantil es **derecho privado especial** —se apoya en el
civil (que es su derecho **supletorio**) pero lo **especializa** para el tráfico profesional—.
Definir **qué es "mercantil"** (la *materia de comercio*) es decisivo, porque determina **qué ley
aplica, qué tribunal conoce, qué reglas de prueba y prescripción rigen y qué grado de
formalismo** se exige. Y la figura central que organiza la materia moderna ya no es solo el "acto
de comercio" aislado, sino la **empresa**: la organización profesional de capital y trabajo para
...
- **Comprender la empresa** como categoría jurídico-económica central del derecho mercantil moderno
  y su relación con el "fondo de comercio" / negociación mercantil.
- **Manejar las fuentes** del Derecho Mercantil (legislación, **usos y prácticas**, supletoriedad
  del derecho civil) y su jerarquía.
- **Ubicar el sistema** del Nivel III: cómo este libro conecta con sociedades, títulos de crédito,
  contratos mercantiles, mercado de valores y concurso.

## 3. Importancia profesional

El marco mercantil es el **terreno** sobre el que se juega toda la práctica corporativa:

1. **Define qué reglas aplican.** Saber si una operación es mercantil decide el **régimen** (Código
   de Comercio y leyes especiales vs. derecho civil), la **competencia** (jurisdicción mercantil),
   la **prescripción** (plazos mercantiles, a menudo más cortos) y la **prueba**.
2. **La empresa es el cliente.** El abogado corporativo asesora **empresas**; entender la empresa
   como organización (no como un mero contrato) es la base de todo lo demás.
3. **Las obligaciones del comerciante son materia de compliance y due diligence.** La inscripción
   en el Registro Público de Comercio, la **contabilidad** y la conservación de documentos son
   verificaciones rutinarias en una adquisición.
4. **Las fuentes mercantiles incluyen los usos.** A diferencia del civil, en el comercio los **usos
   y prácticas** son fuente relevante (Incoterms, prácticas bancarias): clave en contratos
   internacionales.

## 4. Historia de la institución

El Derecho Mercantil nació del **comercio mismo**, no de los códigos:
- **Antigüedad:** los fenicios, griegos y romanos comerciaban; Roma tenía el *ius gentium*
  (derecho común a todos los pueblos) que regía el comercio con extranjeros, más flexible que el
  *ius civile*. Pero Roma no tuvo un "derecho mercantil" autónomo.
- **Edad Media (el origen real):** en las ciudades comerciales italianas (Génova, Venecia,
  Florencia) y en las ferias europeas, los **propios comerciantes** crearon su derecho: la **lex
  mercatoria**, un conjunto de **usos y costumbres** del comercio, aplicado por **tribunales
  consulares** (de los gremios de mercaderes), rápido y profesional. Aquí nacen la letra de cambio,
  la sociedad, la quiebra, el seguro y la contabilidad por partida doble.
- **Edad Moderna:** los Estados **nacionalizan** y **codifican** la lex mercatoria. Las Ordenanzas
  francesas (Colbert, s. XVII) y, sobre todo, el **Código de Comercio francés de 1807** (Napoleón)
  consagran un derecho mercantil **estatal**, basado en el **acto de comercio** (sistema objetivo).
- **México:** tras los Códigos de Comercio de 1854 (Código Lares) y 1884, rige el **Código de
  Comercio de 1889**, aún vigente (muy reformado), de inspiración francesa. Con el tiempo, la
  materia se ha ido **descodificando**: las grandes instituciones salieron a **leyes especiales**
  (LGSM, LGTOC, LMV, Ley de Concursos Mercantiles), quedando el Código de Comercio como tronco
  general.

## 5. Evolución histórica

- **De subjetivo a objetivo y de vuelta a la empresa.** El derecho mercantil medieval era
  **subjetivo** (derecho de los **comerciantes**, de los gremios). El Código francés de 1807 lo
  volvió **objetivo** (derecho de los **actos de comercio**, los aplique quien los aplique). El
  derecho moderno (influencia italiana y alemana) gira hacia la **empresa** como categoría central
  (derecho de la empresa / *Unternehmensrecht*): lo relevante es la **organización profesional**,
  no el acto aislado ni el estatus personal.
- **Descodificación y especialización:** del Código único a un **archipiélago de leyes especiales**
  (sociedades, títulos, valores, competencia, concursos, protección al consumidor).
- **Internacionalización y nueva lex mercatoria:** el comercio global recupera la idea de un derecho
  transnacional de los negocios: **Incoterms**, reglas de la CCI, **CISG**, principios UNIDROIT,
  arbitraje comercial internacional. La lex mercatoria "renace" en clave global.
- **Digitalización:** comercio electrónico, firma electrónica, títulos y registros digitales,
  fintech: el derecho mercantil se adapta de nuevo a una revolución tecnológica, como hizo con la
  letra de cambio hace siglos.

> **Idea de evolución clave:** el Derecho Mercantil es el derecho que **sigue al comercio**. Nació
> de los usos de los mercaderes, se estatalizó y codificó, se especializó en leyes y hoy se
> reinternacionaliza y digitaliza. Entender esa plasticidad explica por qué es la rama más **viva** y
> pegada a la realidad económica.

## 6. Contexto económico

El Derecho Mercantil es la **infraestructura jurídica de la economía de mercado**. Provee las
herramientas que el comercio necesita: la **empresa** (organización eficiente de la producción —
Coase, Libro 9 Nivel I), la **sociedad** (para reunir capital con responsabilidad limitada), los
**títulos de crédito** (para movilizar el crédito y el pago), el **mercado de valores** (para
financiar a gran escala) y el **concurso** (para reasignar los recursos de las empresas inviables).
Sin estas instituciones, la economía moderna —de gran escala, capital intensivo y crédito— sería
imposible. El derecho mercantil **reduce los costos de transacción** del comercio profesional con
reglas estandarizadas, ágiles y predecibles.

**Visto en clave económica, el derecho mercantil es una máquina de reducir costos de transacción**, y cada
una de sus instituciones características es un atajo con una función identificable:

| La institución mercantil | El costo que reduce |
|---|---|
| Los títulos de crédito y las sociedades **estandarizados** | El costo de negociar y verificar cada operación desde cero |
| La **presunción de solidaridad** y de onerosidad | El costo de pactar expresamente lo que el comercio da por supuesto |
| Las **vías ejecutivas** y los plazos breves | El costo de cobrar, que es el que determina si vale la pena dar crédito |
| Los **usos y prácticas** como fuente | El costo de que la ley persiga a un comercio que cambia más rápido que ella |

> Esa es la respuesta profunda a la pregunta de por qué existe una rama separada: no por tradición
> histórica, sino porque **el intercambio profesional y repetido necesita reglas más rápidas y más
> predecibles que las del acto civil aislado.**

**Y la crítica que hay que conocer, porque es real:** la distinción civil/mercantil genera **inseguridad**.
Buena parte de la litigiosidad cotidiana en cobranza empresarial no es sobre el fondo, sino sobre la
**calificación del acto** —si es mercantil o civil— porque de ella dependen la vía procesal y la
prescripción (art. 75 CCom ⟳). Un mismo hecho, dos regímenes. Y hay una segunda objeción de fondo: al
presumir profesionalidad en ambas partes, el derecho mercantil puede **desproteger al pequeño comerciante**
frente al grande, que es exactamente lo contrario de lo que el legislador supuso.

*Consecuencia de oficio:* en la práctica, el abogado **elige y fundamenta** la mercantilidad del acto para
acelerar la recuperación. No es un tecnicismo: es la diferencia entre cobrar en meses y cobrar en años.
...
El comercio es una actividad social que genera **riqueza, empleo y desarrollo**, pero también
**riesgos** (fraudes, abusos, crisis). El Derecho Mercantil equilibra la **agilidad** que el
comercio exige con la **protección** de quienes contratan con comerciantes (consumidores,
acreedores, inversionistas). La **empresa familiar** —columna vertebral del tejido económico
mexicano— vive en este derecho: su constitución, gobierno, sucesión y profesionalización son
problemas jurídico-mercantiles con honda dimensión social y humana.

## 9. Contexto empresarial

Este libro define **qué es la empresa** y **quién es comerciante**, las dos nociones que estructuran
la vida del cliente corporativo:
- **La empresa** como organización (capital + trabajo + organización) que el derecho reconoce y
  regula; su "envoltura" jurídica habitual es la **sociedad mercantil** (persona moral, Libro 5
  Nivel I), pero la empresa es un fenómeno **económico** que el derecho captura de varias formas.
- **El comerciante** y sus **deberes profesionales**: inscribirse en el Registro Público de
  Comercio, llevar **contabilidad** ordenada, conservar correspondencia y documentación. Estos
  deberes son la base de la **transparencia** y, por tanto, de la **due diligence** y el
  **compliance**.
- **El "fondo de comercio" / negociación mercantil:** el conjunto organizado de elementos
  (clientela, nombre comercial, marcas, instalaciones, mercancías) que constituye la empresa en
  marcha y que puede transmitirse como **unidad** (clave en *asset deals*).
...
- **Alfredo Rocco, *Principios de derecho mercantil*.** El clásico italiano sobre la naturaleza y los
  límites de la materia; sigue siendo la mejor exposición de por qué existe una rama separada.
- **Broseta Pont, *Manual de derecho mercantil*.** La referencia española moderna, cercana a nuestra
  tradición y útil para el estudio sistemático.
- **Roy Goode, *Commercial Law*.** El equivalente del *common law*: cómo un sistema sin código de comercio
  resuelve los mismos problemas. Leerlo junto a Rocco es la mejor formación comparada disponible.
- **El *Uniform Commercial Code* estadounidense**, como modelo de **codificación privada uniforme**
  adoptada por los estados: flexible, actualizable y orientada a los usos del comercio. Es el contraste que
  explica la propuesta del §28 —México conserva un Código de Comercio de 1889 parcheado y ganaría con una
  recodificación moderna, orientada a la empresa y armonizada con estándares internacionales—.
- **Principios UNIDROIT sobre los contratos comerciales internacionales**, para el *soft law* que hoy
  funciona como lengua común del comercio transfronterizo.
