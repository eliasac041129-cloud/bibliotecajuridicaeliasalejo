...
> **información veraz y oportuna** para que el inversionista decida. Aquí la sociedad anónima alcanza
> su forma máxima —la **S.A.B.**—, nace la **IPO**, y el gobierno corporativo se vuelve obligatorio
> y reforzado. Es el escenario del financiamiento corporativo de élite y del M&A público.

**Etiquetas:** derecho mercantil · mercado de valores · emisoras (S.A.B.) · IPO · CNBV · gobierno corporativo bursátil
**Prerrequisitos:** [Sociedades (LGSM)](./02-Sociedades-Mercantiles-LGSM.md), [Títulos y Operaciones de Crédito (LGTOC)](./03-Titulos-y-Operaciones-de-Credito-LGTOC.md), [Economía para juristas](../Nivel-I-Fundamentos/10-Economia-para-Juristas.md).
...
reconocimiento: 10–12 h. *Estúdialo en bloques: estructura del mercado e intermediarios → emisoras y
oferta pública (IPO) → instrumentos → gobierno corporativo bursátil y regulación.*

> **Aviso de método.** Tratado, no repaso. Es la materia que conecta el derecho societario con las
> finanzas y el M&A público: la trabajamos con profundidad, ejemplos trabajados, "cómo razona un
> socio" y conexión con IPO, OPA, gobierno corporativo y financiamiento.
...
Empresa Familiar     ★★★☆☆
```
*Es el techo del financiamiento corporativo y la antesala del M&A público (OPAs), las IPO y el
gobierno corporativo de clase mundial.*

## 1. Introducción

Hay dos formas de financiar una empresa grande: el **crédito** (que ya estudiamos: bancos, LGTOC) y
el **mercado de valores** (acudir al público inversionista). El mercado de valores resuelve un
problema económico mayúsculo: **conectar a quienes tienen ahorro** (millones de inversionistas,
fondos de pensiones, aseguradoras) **con quienes necesitan capital** (las empresas), a una escala que
ningún intermediario individual podría. La empresa emite **valores** —**acciones** (capital) u
**obligaciones/certificados** (deuda)— que se colocan entre el público y luego se negocian en la
**bolsa**, dándoles **liquidez**.

La idea central de este libro: el mercado de valores funciona sobre una premisa innegociable —la
**información**—. Como el inversionista no conoce la empresa, la ley exige **transparencia total**
(*disclosure*): la emisora debe revelar su situación financiera, sus riesgos y los hechos relevantes,
de forma veraz y oportuna; y se **prohíbe** usar información privilegiada (*insider trading*) y
manipular el mercado. Por eso la sociedad que cotiza —la **S.A.B.**— está sujeta a un régimen
**reforzado** de gobierno corporativo (consejo con independientes, comités, deberes fiduciarios
agravados) y a la supervisión de la **CNBV**. Para el abogado corporativo, este es el escenario del
financiamiento de élite, de la **IPO** (salida a bolsa) y del M&A público (**OPAs**): el campo de los
despachos y los socios de primer nivel.

## 2. Objetivos del libro

Al terminar, el lector será capaz de:

- **Entender la estructura del mercado de valores**: emisoras, inversionistas, **intermediarios**
  (casas de bolsa), bolsas (BMV, BIVA), **Indeval** (depósito y liquidación) y el regulador (**CNBV**).
- **Dominar el concepto de valor** y los principales **instrumentos**: acciones, **certificados
  bursátiles** (deuda), obligaciones, **FIBRAS** y **CKDs/CERPIs** (vehículos de inversión).
- **Manejar la oferta pública y la IPO**: requisitos de inscripción en el RNV, **prospecto de
  colocación**, *due diligence*, *underwriting* (colocación) y listado.
- **Comprender la S.A.B.** y su **gobierno corporativo reforzado**: consejo, **consejeros
  independientes**, comités de **auditoría** y de **prácticas societarias**, deberes de **diligencia
  y lealtad** agravados.
- **Aplicar el régimen de información y conducta**: *disclosure* de eventos relevantes, prohibición
  de **uso de información privilegiada** y de **manipulación de mercado**.
- **Conectar con el M&A público**: la **oferta pública de adquisición (OPA)**, las tomas de control y
  la protección de minoritarios.

## 3. Importancia profesional

El mercado de valores es el **techo del derecho corporativo y el financiamiento**:

1. **Es el financiamiento a gran escala.** Las IPO y las emisiones de deuda (certificados bursátiles)
   captan miles de millones; estructurarlas es trabajo de los despachos líderes.
2. **Es el escenario del M&A público.** Las **OPAs** (ofertas públicas de adquisición), las tomas de
   control de empresas listadas y las fusiones de públicas son operaciones de máxima complejidad y
   valor.
3. **Define el gobierno corporativo de élite.** El régimen de la S.A.B. (consejeros independientes,
   comités, deberes fiduciarios) es el estándar de gobierno que luego se exporta a las empresas
   privadas.
4. **Es el corazón del compliance financiero.** El *insider trading*, la manipulación de mercado y el
   *disclosure* son materia de altísimo riesgo regulatorio y penal.

## 4. Historia de la institución

- **Orígenes:** las primeras **bolsas** nacieron para negociar las acciones de las grandes compañías
  coloniales (Ámsterdam, s. XVII — la VOC, Libro 2 Nivel III) y la deuda pública. El mercado de
  valores creció con el capitalismo industrial (s. XIX), financiando ferrocarriles e industrias.
- **La gran lección regulatoria (1929):** el **crac de 1929** y la Gran Depresión revelaron los
  peligros del mercado sin regulación (fraudes, manipulación, falta de información). La respuesta de
  EE. UU. fue fundacional: la **Securities Act de 1933** (regula la **oferta**: disclosure, prospecto)
  y la **Securities Exchange Act de 1934** (regula el **mercado secundario** y crea la **SEC**). Estas
  leyes —basadas en el principio de ***full disclosure***— son el ADN de toda la regulación bursátil
  mundial.
- **México:** la **Bolsa Mexicana de Valores** tiene raíces en el s. XIX; la regulación moderna se
  consolidó con la **Ley del Mercado de Valores de 1975** y, sobre todo, con la **LMV de 2005**
  (vigente, reformada), que modernizó las emisoras, creó la **S.A.B.** y la **S.A.P.I.** (Libro 2
  Nivel III), reforzó el gobierno corporativo y endureció el régimen de información privilegiada. En
  2014 surgió **BIVA** como segunda bolsa, rompiendo el monopolio de la BMV.

## 5. Evolución histórica

- **Del mercado libre al mercado regulado:** del *laissez faire* bursátil del s. XIX al régimen de
  *disclosure* y supervisión tras 1929 (SEC). La regulación es la condición de la **confianza**.
- **De la acción al portafolio de instrumentos:** del simple título accionario a una **gama** de
  valores (deuda corporativa, estructurados, derivados, vehículos de inversión: FIBRAS, CKDs, CERPIs).
- **De la BMV monopólica a la competencia (BIVA, 2018)** y a la **internacionalización** (SIC —Sistema
  Internacional de Cotizaciones—, *dual listings*, ADRs en EE. UU.).
- **De la desmaterialización a la digitalización:** los valores se manejan por **anotaciones en
  cuenta** (Indeval; Libro 3 Nivel III: desmaterialización del título), y emergen las *fintech*, el
  *crowdfunding* (Ley Fintech) y los activos digitales.
- **Del gobierno corporativo voluntario al obligatorio:** los **códigos de mejores prácticas**
  (voluntarios) se volvieron, en buena parte, **derecho positivo** para las S.A.B. (LMV): consejeros
  independientes, comités, deberes fiduciarios.

> **Idea de evolución clave:** la historia del mercado de valores es la historia de la **confianza
> regulada**. Cada crisis (1929, 2008, fraudes corporativos como Enron) produjo más **información,
> más gobierno corporativo y más supervisión**. El derecho bursátil es, en esencia, **derecho de la
> información y de la confianza**.

## 6. Contexto económico

El mercado de valores cumple funciones económicas centrales (Libros 9 y 10, Nivel I):
- **Canalización del ahorro a la inversión:** conecta el ahorro disperso (incluidos los fondos de
  pensiones —Afores—) con las empresas que necesitan capital. Es un motor del **crecimiento**.
- **Asignación eficiente y formación de precios:** el precio de mercado de un valor refleja
  (idealmente) toda la información disponible (**hipótesis de mercados eficientes**, Libro 10) y guía
  la asignación de capital hacia las empresas más prometedoras.
- **Liquidez:** la bolsa permite **vender** la inversión rápidamente, lo que la hace atractiva.
- **Disciplina de mercado:** el precio de la acción y la amenaza de una **OPA hostil** disciplinan a
  los administradores (mercado por el control corporativo — resuelve el problema de agencia, Libro 9).
...
el retiro (Afores) y es sensible a la **estabilidad financiera**. El Estado regula intensamente vía la
**CNBV** (supervisión de emisoras, intermediarios y bolsas), el **Banco de México** (sistemas de
pago, política monetaria) y la **SHCP**. La regulación busca **proteger al inversionista** y la
**integridad del mercado** (contra el fraude, el *insider trading* y la manipulación), porque la
confianza es un bien público: un solo escándalo puede contaminar todo el mercado. La tensión política:
**fomentar el mercado** (menos carga regulatoria, más empresas listadas) vs. **protegerlo** (más
regulación, más confianza). México tiene un mercado **relativamente pequeño** (pocas emisoras), lo que
es, en sí, un tema de política económica.

## 8. Contexto social

El mercado de valores afecta a la sociedad más de lo que parece: el **ahorro para el retiro** de
millones de trabajadores (vía Afores) está invertido en valores; las **crisis financieras** (2008)
muestran cómo el mercado puede dañar a toda la economía; y la **democratización de la inversión**
(apps de inversión, *fintech*) acerca el mercado a más personas, con oportunidades y riesgos. La
**protección del inversionista** —especialmente el pequeño y el no sofisticado— es un objetivo social,
igual que la **educación financiera**. Un mercado de valores sano y confiable es infraestructura
social, no solo económica.

## 9. Contexto empresarial

Para la empresa, el mercado de valores es la **gran liga del financiamiento**:
- **Salir a bolsa (IPO):** convertirse en **S.A.B.** y captar capital del público; da acceso a
  financiamiento, liquidez para los socios y prestigio, pero impone **transparencia**, **gobierno
  corporativo reforzado** y escrutinio permanente.
- **Emitir deuda (certificados bursátiles):** financiarse con el público sin diluir el capital
  (alternativa al crédito bancario, a menudo más barata para grandes emisores).
- **Vehículos de inversión:** **FIBRAS** (inmobiliario), **CKDs/CERPIs** (capital privado/proyectos):
  vehículos bursátiles que canalizan inversión a sectores específicos.
- **El costo de ser pública:** *disclosure* continuo, gobierno corporativo, comités, auditoría,
  responsabilidad agravada de administradores. Muchas empresas (y familias) valoran la
  **privacidad** de no cotizar.
- **M&A público:** ser pública expone a **OPAs** (incluso hostiles); la empresa debe tener defensas y
  gobierno robusto.
