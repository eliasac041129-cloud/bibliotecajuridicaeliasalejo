...
> SPA, un crédito sindicado, unos estatutos, un *joint venture agreement*: todos son
> contratos. Este libro enseña a entender, redactar e interpretar cualquiera de ellos.

**Etiquetas:** fundamentos · teoría general del contrato · autonomía de la voluntad · interpretación · redacción
**Prerrequisitos:** [Acto Jurídico](./04-Teoria-General-del-Acto-Juridico.md), [Obligaciones](./07-Obligaciones.md).
**Nivel de tratamiento:** TRATADO (materia nuclear: el contrato es el instrumento central del derecho de los negocios).

> **Cómo está escrito este libro.** Cada figura se define, se explica su función, se ilustra
> con un ejemplo y se conecta con la **redacción** de una cláusula real. El objetivo es que
> sepas **leer, criticar y construir** un contrato, no solo describirlo.
...
Razonemos desde lo aprendido. En Acto Jurídico viste que la voluntad crea efectos; en
Obligaciones, que el vínculo obliga a dar/hacer/no hacer. El **contrato** une ambas ideas: es
el **acto jurídico bilateral** (acuerdo de dos o más voluntades) cuya función específica es
**crear y transmitir obligaciones**. Es el instrumento por el que los particulares
**autorregulan** sus intereses económicos.

¿Por qué necesita el derecho una teoría general del contrato? Porque el contrato es el
**vehículo universal del intercambio**: comprar, vender, prestar, arrendar, asociarse,
financiar, fusionar. Y porque, siendo infinitos los contratos posibles, necesitamos reglas
**comunes** (cómo se forman, interpretan, cumplen y deshacen) que se apliquen a todos.

Su importancia para el abogado corporativo es **total**, y por eso es un tratado:

**Primero: el contrato es tu producto.** El abogado transaccional **vive** de redactar,
negociar e interpretar contratos. El dominio de la teoría general (formación, efectos,
interpretación, vicisitudes) es la diferencia entre quien "llena formatos" y quien **diseña**
un contrato que protege a su cliente y resiste el litigio.

**Segundo: la autonomía de la voluntad y sus límites definen tu margen creativo.** Saber qué
puedes pactar libremente (normas dispositivas) y qué no (normas imperativas, orden público)
es lo que te permite **innovar** (crear contratos atípicos: *joint ventures*, *earn-outs*,
*shareholders agreements*) sin caer en la nulidad.

**Tercero: la interpretación contractual es donde se ganan y pierden los casos.** La mayoría
de los litigios corporativos no discuten los hechos, sino **qué significa** una cláusula. Las
reglas de interpretación (intención común, sistemática, *contra proferentem*, buena fe) son
herramientas de combate que debes dominar.

> **Tesis del libro:** el contrato es **ley entre las partes** (*pacta sunt servanda*) dentro
> de los límites del orden público. Comprender su formación, su fuerza obligatoria, su
> interpretación y sus vicisitudes (rescisión, resolución, nulidad) es comprender la
> herramienta con la que se construye —literalmente— toda operación corporativa.

**Ejercicio de arranque:** dos empresas firman un acuerdo donde una "hará sus mejores
esfuerzos" para obtener un permiso. No lo obtiene. ¿Incumplió? Depende de qué tipo de
obligación pactaron y de cómo se **interpreta** "mejores esfuerzos". *Piensa tu respuesta* y
contrástala en la sección 5.5 (interpretación) y 17 (M&A: *best efforts* vs. *reasonable
efforts*).
...
### 2.1 Roma: del contrato típico al consentimiento
Como vimos, Roma no tuvo una teoría general del contrato: tuvo **contratos típicos** (reales,
verbales, literales, consensuales), y el **pacto desnudo** no obligaba (*ex nudo pacto non
oritur actio*). Pero aportó las piezas: el consentimiento, la *causa*, la buena fe de los
contratos consensuales (compraventa, arrendamiento, sociedad, mandato).

### 2.2 Los canonistas y el triunfo del consentimiento
La gran revolución la hicieron los **canonistas** medievales: para ellos, **faltar a la
palabra dada era pecado**, de modo que todo pacto, aun el "desnudo", debía cumplirse
(*pacta sunt servanda* en sentido moral-jurídico). De ahí, vía los iusnaturalistas (Grocio:
*"pacta sunt servanda"* como principio de derecho natural), se universalizó la **fuerza
obligatoria del simple acuerdo**.

### 2.3 El Code y el dogma de la autonomía de la voluntad
El **Code Napoléon** (1804) consagró el contrato como **ley entre las partes** y el dogma de
la **autonomía de la voluntad**: las personas son libres de obligarse como quieran, y lo
pactado las vincula como la ley misma. Es el apogeo del **liberalismo contractual**, base del
capitalismo.

### 2.4 Los correctivos del siglo XX
El dogma se moderó al constatar que la "libertad" contractual entre desiguales puede ser
opresiva. Surgen: la regulación de los **contratos de adhesión** y las **cláusulas abusivas**
(protección del consumidor), la **buena fe** como límite, la **teoría de la imprevisión**
(*rebus sic stantibus*), y la función social del contrato. El contrato deja de ser solo
"voluntad pura" y se llena de estándares de **lealtad y equilibrio**.

### 2.5 La era del contrato moderno y la influencia anglosajona
La globalización trajo el **contrato anglosajón** —extenso, autosuficiente (*self-contained*),
lleno de definiciones, *representations*, *covenants*, *conditions* e *indemnities*— como
estándar de las grandes operaciones. Hoy, el abogado corporativo mexicano trabaja con
contratos que mezclan la **técnica anglosajona** (estructura) y el **derecho sustantivo
...
1. **¿Cómo pueden los particulares crear reglas vinculantes para sí?** Funda la **autonomía de
   la voluntad** y la fuerza obligatoria del contrato.
2. **¿Cuándo y cómo nace el contrato?** Regula la **formación** (oferta y aceptación,
   consentimiento, momento y lugar de perfeccionamiento).
3. **¿A quién y a qué obliga el contrato?** Define sus **efectos** (entre partes —*res inter
   alios acta*— y frente a terceros) y su contenido (lo pactado + buena fe, uso y ley).
4. **¿Qué significa lo que se pactó?** Establece las reglas de **interpretación** e
   **integración**.
5. **¿Cómo se clasifica el universo infinito de contratos?** Crea categorías
   (bilaterales/unilaterales, onerosos/gratuitos, conmutativos/aleatorios, típicos/atípicos,
   de adhesión) que disparan reglas distintas.
6. **¿Cómo se deshace un contrato?** Regula sus **vicisitudes**: nulidad, rescisión,
   resolución, revocación, terminación.

> Para el corporativo, los problemas 2, 4 y 6 son operativos a diario: cómo se forma el
> consentimiento (signing), cómo se interpreta una cláusula y cómo se sale del contrato.
...
- **Aceptación:** conformidad con la oferta; al coincidir con ella, se forma el
  **consentimiento**.
- **Consentimiento:** encuentro de oferta y aceptación sobre objeto y causa. Puede ser
  **expreso** o **tácito**.
- **Contrato bilateral (sinalagmático) y unilateral:** según genere obligaciones para **ambas**
  partes (compraventa) o para **una sola** (donación, mutuo gratuito).
- **Contrato oneroso y gratuito:** según haya provechos y gravámenes recíprocos (oneroso) o
  provecho de una sola parte (gratuito).
- **Conmutativo y aleatorio:** en el **conmutativo**, las prestaciones son ciertas y
  determinadas desde el inicio; en el **aleatorio**, dependen de un acontecimiento incierto
  (seguro, renta vitalicia, *earn-out* en parte).
- **Principal y accesorio:** el accesorio depende de otro (la fianza/hipoteca dependen del
  contrato garantizado): *lo accesorio sigue la suerte de lo principal*.
- **Instantáneo y de tracto sucesivo:** se cumple en un solo acto o se prolonga en el tiempo
  (arrendamiento, suministro).
- **Típico (nominado) y atípico (innominado):** regulado por la ley (compraventa) o creado por
  las partes (*joint venture*, *franchise*, muchos contratos de M&A).
- **Contrato de adhesión:** una parte fija las cláusulas y la otra solo se adhiere (seguros,
  bancarios, telecom); sujeto a control de cláusulas abusivas.
- **Contrato preparatorio (promesa de contrato):** obliga a celebrar un contrato futuro
  (*promesa de compraventa*; antecedente de la *carta de intención* vinculante).
- **Estipulación a favor de tercero:** las partes pactan un beneficio para alguien ajeno al
  contrato.
- **Cláusula:** unidad de contenido del contrato (declaraciones, obligaciones, condiciones,
  garantías, etc.).
...
### 5.1 El contrato como acto jurídico bilateral
El contrato es la especie más importante de acto jurídico. Por tanto, **le aplica toda la
teoría del Libro 4**: requiere elementos de **existencia** (consentimiento, objeto y, si la
ley lo exige, forma solemne) y requisitos de **validez** (capacidad, ausencia de vicios,
licitud, forma); y su falta produce inexistencia o nulidad. No repetimos esa teoría: la
**damos por sabida** y construimos sobre ella. El contrato añade lo específico: la **fuerza
...
### 5.3 La formación del contrato: oferta y aceptación
El consentimiento se forma por el encuentro de **oferta** y **aceptación**. Puntos finos que
todo abogado debe dominar:
- La **oferta** debe ser seria, completa (contener los elementos esenciales) y mantenerse por
  el plazo fijado o el razonable.
- La **aceptación** debe ser **lisa y llana**: si modifica la oferta, es una
  **contraoferta** (no hay contrato hasta que la otra parte la acepte). Esto explica la
  dinámica de **negociación por rondas** (*mark-ups*) de un contrato corporativo.
- **Momento y lugar de perfeccionamiento:** entre presentes, al aceptarse; entre ausentes,
  rige (en México) la teoría de la **recepción** (el contrato se forma cuando el oferente
  **recibe** la aceptación). Importa para fijar cuándo nace el contrato y qué ley/competencia
  aplica.
- **Tratos preliminares y buena fe precontractual:** negociar no obliga a contratar, pero
  romper las negociaciones de mala fe (o no informar lo debido) puede generar
  **responsabilidad precontractual** (*culpa in contrahendo*). De ahí la importancia de las
  **cartas de intención** y de pactar expresamente qué es vinculante y qué no.

### 5.4 Los efectos del contrato: fuerza obligatoria y relatividad
- **Fuerza obligatoria (pacta sunt servanda):** el contrato es **ley entre las partes**; debe
  cumplirse de buena fe.
- **Relatividad (*res inter alios acta*):** el contrato solo obliga y aprovecha a las
  **partes**, no a terceros (con excepciones: estipulación a favor de tercero, contratos
  colectivos). *Por qué importa en M&A:* por eso, para "transmitir" un contrato de la *target*
...
**Cómo razona un experto (walkthrough de interpretación):** ante una cláusula disputada, el
abogado: *(1) lee la letra; (2) busca la intención común real (antecedentes, finalidad del
contrato); (3) la confronta con el resto del contrato (sistemática) y con las definiciones;
(4) busca el sentido que dé efecto útil; (5) considera usos del sector; (6) si subsiste duda,
aplica contra proferentem; (7) verifica coherencia con la buena fe*. Quien hace esto
**construye el argumento ganador** antes de que la contraparte reaccione.

> **Respuesta al ejercicio de arranque:** "hacer sus mejores esfuerzos" es una **obligación de
> medios** (Libro 7), no de resultado: la parte no garantiza obtener el permiso, sino
> **desplegar diligencia razonable** para conseguirlo. Si no lo obtiene **pese a haber actuado
> diligentemente**, no incumple. La clave está en **interpretar** el estándar pactado: en la
> práctica anglosajona se distinguen grados (*best efforts* —el más exigente—, *reasonable
> efforts*, *commercially reasonable efforts*), y un buen contrato **define** qué se exige
> exactamente, para no dejarlo a la interpretación judicial. Redactar con precisión el
> estándar de esfuerzo es justamente el arte que este libro enseña.

### 5.6 Las vicisitudes: cómo se deshace un contrato
...
- **Terminación / revocación / mutuo disenso:** por vencimiento del plazo, por voluntad
  ...
  disenso*).
- **Imprevisión** (donde se admite): revisión o terminación por cambio extraordinario de
  circunstancias.
